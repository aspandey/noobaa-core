...
mocha.describe('s3_bucket_policy', function() {
    ...
    mocha.describe('s3_bucket_policy: Granting access to a specific version of an object ', function() {
        mocha.it('should be able to put access permission based on VersionId', async function() {
            ...
            let policy_version = "";
            const first_versionId = first_res.VersionId;
            policy_version = first_versionId;

            // if (process.env.NC_CORETEST) {
            //     console.log("============= NC first_versionId", first_versionId);
            //     policy_version = first_versionId;
            // } else {
            //     console.log("============= NON NC first_versionId", first_versionId);
            //     policy_version = first_versionId;
            //     // policy_version = first_versionId.split('-')[1];
            // }
            ...
            const version_policy = {
                ...
                Statement: [
                    ...
                    },
                    {
                        ...
                        Condition: {
                            StringNotEquals: {
                                's3:VersionId': policy_version // Use one of the VersionId to set policy
                            }
                        }
                    },
                    {
            ...
            console.log("===================== user_a is trying get first version ", first_versionId);
            // Access should be Allowed
            const res1 = await s3_a.getObject({
                Bucket: VER_BKT,
                Key: object_key,
                VersionId: first_versionId
            });
            ...
            console.log("===================== user_b Accessing all versions ", first_versionId);
            ...
            console.log("===================== user_a is trying DELETE first version ", first_versionId);

            // DELETE should be Allowed : First Version
            const res_del = await s3_a.deleteObject({
                Bucket: VER_BKT,
                Key: object_key,
                VersionId: first_versionId
            });
            ...
            console.log("===================== user_a is trying DELETE Latest version ", first_versionId);

            // DELETE should be Denied: Latest Version
            await assert_throws_async(s3_a.deleteObject({
                Bucket: VER_BKT,
                Key: object_key,
            }));
