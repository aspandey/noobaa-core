...
async function _is_object_version_fit(req, predicate, value) {
    ...
    dbg.error('Condition statement: Requested version-id, value and result :', version_id, value, res);
    return res;
}
...
async function _is_statements_fit(statements, account, method, arn_path, req) {
    for (const statement of statements) {
        ...
        dbg.error("arn_path ======== ", arn_path);
        dbg.error('bucket_policy: is_statements_fit', action_fit, principal_fit, resource_fit, condition_fit);
